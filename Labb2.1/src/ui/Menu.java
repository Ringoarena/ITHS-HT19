...
public class Menu {
    ...
    public void managementMenu() {
        ...
        while (!previous) {
            ...
            System.out.println("4. Raise salary of all employees");
            ...
            switch (Utilities.getInput(0, 4)) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    employeeManager.promoteEmployee(employeeManager.selectEmployeeByID());
                    break;
                case 4:
                    ...
                    break;
                default:
                    System.out.println("Invalid input at managementMenu()");
            }
        }
    }
